...
class TestCommand extends Command {
    ...
    public function handle() {
        ...
        $carriers = [
            ...
            "IDN_POS_INT" => "Indonesia Post International.",
            ...
            "ZA_FASTWAY" => "fastway New Zealand",
            ...
            "CN_DHL_EXPRESS" => "DHL Express China",
            ...
            "DE_DHL_DEUTSCHEPOST" => "DHL Deutschepost Germany",
            ...
            "ASM_ES" => "ASM Tracking Spain",
            "AUPOST_CN" => "Logistics in China",
            "ACOMMMERCE" => "aCommerce",
            "ADICIONAL_PT" => "Adicional Logistics Portugal",
            "AIR_21" => "Air 21",
            "AIRBORNE_EXPRESS_UK" => "Airborne Express UK",
            "AIRPAK_MY" => "Airpak Malaysia",
            "AIRSPEED" => "Airspeed",
            "ASENDIA_DE" => "Asendia Germany",
            "ASENDIA_US" => "Asendia USA",
            "AUSTRALIA_POST" => "Australia Post",
            "TOLL_AU" => "Toll Australia",
            ...
            "DHL_GLOBAL_MAIL" => "DHL eCommerce US",
            "DHL_AT" => "DHL Austria",
            ...
            "DTDC_IN" => "DTDC India",
            "DAWN_WING" => "Dawn Wing",
            "DELHIVERY_IN" => "Delhivery India",
            "DELTEC_DE" => "Deltec Germany",
            "DELTEC_UK" => "Deltec UK",
            "DEUTSCHE_DE" => "Deutsche Post",
            "DIRECTLINK_SE" => "Direct Link Sweden",
            ...
            "HRVATSKA_HR" => "Hrvatska Pošta",
            "HUAHAN_EXPRESS" => "Huahan Express",
            "IMX" => "IMX France",
            "ITIS" => "ITIS International Courier Tracking",
            "INDIA_POST" => "India Post",
            "INTERLINK" => "Interlink Express",
            "INT_SEUR" => "International Seur",
            ...
            "MAGYAR_HU" => "Magyar Posta",
            "MALAYSIA_POST" => "Pos Malaysia Berhad",
            ...
            "NATIONWIDE" => "Nationwide Carrier and Logistics Services",
            "NZ_POST" => "New Zealand Post",
            "NIPOST_NG" => "Nigerian Postal Service",
            ...
            "POCZTEX" => "Pocztex",
            "CTT_PT" => "CTT Expresso Portugal",
            "SEUR_PT" => "Seur Portugal",
            "POS_ID" => "Pos Indonesia Domestic",
            "POS_INT" => "Pos Indonesia International",
            "POSTNL_INT_3_S" => "Koninklijke PostNL",
            "POSTNL" => "PostNL",
            ...
            "REGISTER_MAIL_IT" => "Registered Mail Italy",
            ...
            "SKYNET_UAE" => "SkyNet Worldwide Express Dubai, UAE",
            ...
            "TNT_ES" => "TNT Spain",
            "TNT_UK" => "TNT UK",
            "TPG" => "TPG International & Domestic Express",
            ...
            "WAHANA_ID" => "Wahana Express Indonesia",
            "XEND_EXPRESS_PH" => "Xend Express",
            "XPRESSBEES" => "Xpress Bees",
            "YAMATO" => "Yamato Japan",
            "YANWEN_CN" => "Yanwen China",
            "YODEL" => "Yodel",
            "UPS_CANADA" => "UPS Canada",
            "UPS_MAIL_INNOVATIONS" => "UPS Mail Innovations",
            "DE_DELTEC" => "Deltec Germany",
            "DE_INTERNATIONALSEUR" => "International Seur Germany",
            "FR_DPD" => "DPD France",
            "FR_IMX" => "IMX France",
            "IT_IMX" => "IMX Italy",
            "AU_DTDC" => "DTDC Australia",
            "AU_SENDLE" => "Sendle Australia",
            "AU_SKYNET" => "Skynet Australia",
            "ES_GLS" => "General Logistics Systems (GLS) Spain",
            "ES_INTERNATIONALSEUR" => "Seur International Spain",
            "ES_IMX" => "IMX Spain",
            "CN_HUAHANEXPRESS" => "Huahan Express China",
            "LOCAL_PICKUP" => "Local Pickup",
            "HK_DPEX" => "DPEX Worldwide Hong Kong",
            "HK_KERRYEXPRESS" => "Kerry Express Hong Kong",
            "HK_LOGISTICSWORLDWIDEEXPRESS" => "Logistics Worldwide Express Hong Kong",
            "HK_RPX" => "RPX Hong Kong",
            "HK_SPREADEL" => "Spreadel Hong Kong",
            "IN_SPREADEL" => "Spreadel IN",
            "TH_CJ" => "CJ Thailand",
            "KR_LOGISTICSWORLDWIDE" => "Logistics Worldwide Korea",
            "AT_DHL" => "DHL Austria",
            "BE_IMX" => "IMX Belgium",
            "MY_LOGISTICSWORLDWIDE" => "Logistics Worldwide Malaysia",
            "MY_JETSHIP" => "Jetship Malaysia",
            "SG_DHL" => "DHL Singapore",
            "SG_SPREADEL" => "Spreadel Singapore",
            "POSTAROMANA" => "Romanian Post",
            "US_PUROLATOR" => "Purolator US",
            "US_FASTWAY" => "Fastway US",
            "CHRONOPOST" => "Chronopost",
            "CORREOS_DE_ESPANA" => "Correos de Espana",
            "DEUTSCHE_POST_DHL" => "Deutsche Post DHL",
            "EBOOST_SDA" => "Posteitaliane",
            "HONGKONG_POST" => "Hong Kong Post",
            "INTANGIBLE_DIGITAL_SERVICES" => "Intangible Digital Services",
            "LA_POSTE" => "La Poste",
            "LA_POSTE_SUIVI" => "La Poste Suivi",
            "NEKO_YAMATO_UNYUU" => "Yamato Transport Co.",
            "NITTSU_PELICAN_BIN" => "Nippon Express",
            "POSTE_ITALIA" => "Posteitaliane",
            "SAGAWA_KYUU_BIN" => "Sagawa Express Co.",
            "STAR_TRACK_EXPRESS" => "Star Track Express",
            "US_DTDC" => "DTDC US",
            "US_STARTRACK" => "Star Track US",
            "ISR_ISRAEL_POST" => "Israel Post",
            "BE_MONDIAL" => "Mondial Belgium",
            "B_2_CEUROPE" => "B2C Europe",
            "PHL_2_GO" => "2GO Shipping Philippines",
            "PHL_AIR_21" => "Air 21 Philippines",
            "PT_SPANISH_SEUR" => "Internationational Seur Spanish Portugal",
            "ES_SPANISH_SEUR" => "Seur Spain",
            "SG_DPEX" => "DPEX Worldwide Singapore",
            "CH_IMX" => "IMX Switzerland",
            "DHLG" => "DHLG",
            "RUSTON" => "Ruston",
            ...
            "DE_DEUTSCHE_POST_DHL_WITHIN_EUROPE_TRACKNET" => "Deutsche Post DHL",
