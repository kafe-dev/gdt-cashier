...
class PayPalAPI {
     ...
     * @throws \JsonException
     */
    public function issueRefund(string $capture_id, string $refund_type, ?string $custom_id, ?string $invoice_id, ?string $note_to_payer, ?string $currency_code, ?string $value): array {
